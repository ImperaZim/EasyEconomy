...
class GiveSubCommand extends BaseSubCommand {
 ...
 protected function prepare() : void {
  $this->setPermission("easyeconomy.command.give");
 ...
 public function onRun(CommandSender $sender, string $aliasUsed, array $args) : void {
  ...
  $sender->sendMessage(EasyEconomy::getProcessedTags($tags, $plugin->getMessages()->getNested("messages.givemoney.successfully_gave_money")));
  $target->sendMessage(EasyEconomy::getProcessedTags($tags, $plugin->getMessages()->getNested("messages.givemoney.successfully_given_money")));
 }
}
